    ...
    return (
      <>
          ...
          <div style={{minHeight: "calc(100vh - 95px)", height: "1px"}}>
              <div style={{marginTop: "10vh", marginBottom: "10vh", marginLeft: "2rem", marginRight: "2rem", height: "100%"}}>
                  ...
                  <div style={{
                      ...
                      <div style={{...flexChild, display: "flex", justifyContent: "center"}} className={"col-sm-6"}>
                          {/* <iframe
                              ...
                              width="80%" height="400"  allowFullScreen="" loading="lazy" style={{border: "none"}}
